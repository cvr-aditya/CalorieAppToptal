 ...
 * Login as user_manager and do CRUD meals
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class UserManagerMealResourceTest {
    ...
    private static final String email = "user_manager@gmail.com";
